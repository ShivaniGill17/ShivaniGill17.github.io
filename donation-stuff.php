  <div class="container donation-st">
    ...
    <select class="cat_drop" name="donation-stuff" id="donation-menu">
        ...
        <option value="s-individual.php">donation from Individual</option>
        <option value="s-organisation.php">donation from Organisation</option>
        <option value="s-school.php">donation from School</option>
        <option value="s-university.php">donation from University/College</option>
