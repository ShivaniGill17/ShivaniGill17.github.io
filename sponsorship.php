...
?>
    <div class="container donation-st">
        <div class="row">
            <h2>To sponsor a child please select the category and fill your details correctly</h2>
            <div class="col-md-12">
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12"></div>
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 donation-st-ctn">
            <p>CHOOSE YOUR CATEGORY</p>
    <form name="sponsor-form">
          
    <select class="cat_drop" name="sponsor" id="sponsor-menu">
        <option value="nothing" selected="selected">--SELECT--</option>
        <option value="sponsor-individual.php">Individual</option>
        <option value="sponsor-org.php">Organisation</option>
    ...
    <script type="text/javascript">
        ...
        var url=document.getElementById("sponsor-menu");
